...
/**
 * @generated from protobuf message mediacorral.metadata.v1.AnalyzeMkvRequest
 */
...
/**
 * @generated from protobuf message mediacorral.metadata.v1.AnalyzeMkvResponse
 */
export interface AnalyzeMkvResponse {
    /**
     * Includes overall metadata about the content
     *
     * @generated from protobuf field: mediacorral.metadata.v1.MediaDetails media_details = 1
     */
     ...
     *
     * @generated from protobuf field: optional mediacorral.metadata.v1.AggregatedSubtitles aggregated_subtitles = 2
     */
 ...
 * different one.
 *
 * @generated from protobuf message mediacorral.metadata.v1.AggregatedSubtitles
 */
 ...
 * by other services.
 *
 * @generated from protobuf message mediacorral.metadata.v1.MediaDetails
 */
export interface MediaDetails {
    ...
    duration: number;
    /**
     * @generated from protobuf field: repeated mediacorral.metadata.v1.ChapterInfo chapter_info = 2
     */
    chapterInfo: ChapterInfo[];
    /**
     * @generated from protobuf field: repeated mediacorral.metadata.v1.VideoTrack video_tracks = 3
     */
    videoTracks: VideoTrack[];
    /**
     * @generated from protobuf field: repeated mediacorral.metadata.v1.AudioTrack audio_tracks = 4
     */
    audioTracks: AudioTrack[];
    /**
     * @generated from protobuf field: repeated mediacorral.metadata.v1.SubtitleTrack subtitle_tracks = 5
     */
 ...
 *
 * @generated from protobuf message mediacorral.metadata.v1.ChapterInfo
 */
 ...
 *
 * @generated from protobuf message mediacorral.metadata.v1.VideoTrack
 */
export interface VideoTrack {
    ...
    codecId: string;
    /**
     * @generated from protobuf field: mediacorral.metadata.v1.VideoStereoMode stereo_mode = 12
     */
 ...
 *
 * @generated from protobuf message mediacorral.metadata.v1.AudioTrack
 */
 ...
 *
 * @generated from protobuf message mediacorral.metadata.v1.SubtitleTrack
 */
 ...
 *
 * @generated from protobuf enum mediacorral.metadata.v1.VideoStereoMode
 */
...
class AnalyzeMkvRequest$Type extends MessageType<AnalyzeMkvRequest> {
    constructor() {
        super("mediacorral.metadata.v1.AnalyzeMkvRequest", [
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.AnalyzeMkvRequest
 */
...
class AnalyzeMkvResponse$Type extends MessageType<AnalyzeMkvResponse> {
    constructor() {
        super("mediacorral.metadata.v1.AnalyzeMkvResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AnalyzeMkvResponse): AnalyzeMkvResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* mediacorral.metadata.v1.MediaDetails media_details */ 1:
                    message.mediaDetails = MediaDetails.internalBinaryRead(reader, reader.uint32(), options, message.mediaDetails);
                    break;
                case /* optional mediacorral.metadata.v1.AggregatedSubtitles aggregated_subtitles */ 2:
    ...
    internalBinaryWrite(message: AnalyzeMkvResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* mediacorral.metadata.v1.MediaDetails media_details = 1; */
        ...
        /* optional mediacorral.metadata.v1.AggregatedSubtitles aggregated_subtitles = 2; */
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.AnalyzeMkvResponse
 */
...
class AggregatedSubtitles$Type extends MessageType<AggregatedSubtitles> {
    constructor() {
        super("mediacorral.metadata.v1.AggregatedSubtitles", [
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.AggregatedSubtitles
 */
export const AggregatedSubtitles = new AggregatedSubtitles$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MediaDetails$Type extends MessageType<MediaDetails> {
    constructor() {
        super("mediacorral.metadata.v1.MediaDetails", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 duration */ 1:
                    ...
                    break;
                case /* repeated mediacorral.metadata.v1.ChapterInfo chapter_info */ 2:
                    message.chapterInfo.push(ChapterInfo.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated mediacorral.metadata.v1.VideoTrack video_tracks */ 3:
                    message.videoTracks.push(VideoTrack.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated mediacorral.metadata.v1.AudioTrack audio_tracks */ 4:
                    message.audioTracks.push(AudioTrack.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated mediacorral.metadata.v1.SubtitleTrack subtitle_tracks */ 5:
    ...
    internalBinaryWrite(message: MediaDetails, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated mediacorral.metadata.v1.ChapterInfo chapter_info = 2; */
        ...
        /* repeated mediacorral.metadata.v1.VideoTrack video_tracks = 3; */
        ...
        /* repeated mediacorral.metadata.v1.AudioTrack audio_tracks = 4; */
        ...
        /* repeated mediacorral.metadata.v1.SubtitleTrack subtitle_tracks = 5; */
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.MediaDetails
 */
export const MediaDetails = new MediaDetails$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChapterInfo$Type extends MessageType<ChapterInfo> {
    constructor() {
        super("mediacorral.metadata.v1.ChapterInfo", [
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.ChapterInfo
 */
export const ChapterInfo = new ChapterInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class VideoTrack$Type extends MessageType<VideoTrack> {
    constructor() {
        super("mediacorral.metadata.v1.VideoTrack", [
            ...
            { no: 12, name: "stereo_mode", kind: "enum", T: () => ["mediacorral.metadata.v1.VideoStereoMode", VideoStereoMode, "VIDEO_STEREO_MODE_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string codec_id */ 11:
                    ...
                    break;
                case /* mediacorral.metadata.v1.VideoStereoMode stereo_mode */ 12:
    ...
    internalBinaryWrite(message: VideoTrack, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* mediacorral.metadata.v1.VideoStereoMode stereo_mode = 12; */
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.VideoTrack
 */
export const VideoTrack = new VideoTrack$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AudioTrack$Type extends MessageType<AudioTrack> {
    constructor() {
        super("mediacorral.metadata.v1.AudioTrack", [
            { no: 1, name: "track_number", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "track_uid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "hash", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 4, name: "enabled", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.AudioTrack
 */
export const AudioTrack = new AudioTrack$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubtitleTrack$Type extends MessageType<SubtitleTrack> {
    constructor() {
        super("mediacorral.metadata.v1.SubtitleTrack", [
            { no: 1, name: "track_number", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "track_uid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "hash", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 4, name: "enabled", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
...
/**
 * @generated MessageType for protobuf message mediacorral.metadata.v1.SubtitleTrack
 */
export const SubtitleTrack = new SubtitleTrack$Type();
/**
 * @generated ServiceType for protobuf service mediacorral.metadata.v1.MediaAnalysisService
 */
export const MediaAnalysisService = new ServiceType("mediacorral.metadata.v1.MediaAnalysisService", [
