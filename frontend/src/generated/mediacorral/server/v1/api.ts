...
class Movie$Type extends MessageType<Movie> {
    constructor() {
        super("mediacorral.server.v1.Movie", [
            ...
            { no: 3, name: "poster_blob", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional int64 poster_blob */ 3:
                    message.posterBlob = reader.int64().toString();
                    break;
                case /* string title */ 4:
...
class ListTvSeasonsRequest$Type extends MessageType<ListTvSeasonsRequest> {
    constructor() {
        super("mediacorral.server.v1.ListTvSeasonsRequest", [
            { no: 1, name: "series_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 series_id */ 1:
                    message.seriesId = reader.int64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class TvSeason$Type extends MessageType<TvSeason> {
    constructor() {
        super("mediacorral.server.v1.TvSeason", [
            { no: 1, name: "id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 2, name: "tmdb_id", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "tv_show_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 4, name: "season_number", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "poster_blob", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 tv_show_id */ 3:
                    message.tvShowId = reader.int64().toString();
                    break;
...
class ListTvEpisodesRequest$Type extends MessageType<ListTvEpisodesRequest> {
    constructor() {
        super("mediacorral.server.v1.ListTvEpisodesRequest", [
            { no: 1, name: "tv_season_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ }
        ]);
    }
    create(value?: PartialMessage<ListTvEpisodesRequest>): ListTvEpisodesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.tvSeasonId = "0";
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 tv_season_id */ 1:
                    message.tvSeasonId = reader.int64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class TvEpisode$Type extends MessageType<TvEpisode> {
    constructor() {
        super("mediacorral.server.v1.TvEpisode", [
            ...
            { no: 2, name: "tmdb_id", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "tv_show_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 4, name: "tv_season_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 5, name: "episode_number", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "thumbnail_blob", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional int64 thumbnail_blob */ 6:
                    message.thumbnailBlob = reader.int64().toString();
                    break;
                case /* string title */ 7:
                    message.title = reader.string();
                    break;
...
class GetTvEpisodeRequest$Type extends MessageType<GetTvEpisodeRequest> {
    constructor() {
        super("mediacorral.server.v1.GetTvEpisodeRequest", [
            { no: 1, name: "episode_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 episode_id */ 1:
                    message.episodeId = reader.int64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class TagFileRequest$Type extends MessageType<TagFileRequest> {
    constructor() {
        super("mediacorral.server.v1.TagFileRequest", [
            { no: 1, name: "file", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 2, name: "video_type", kind: "enum", T: () => ["mediacorral.server.v1.VideoType", VideoType, "VIDEO_TYPE_"] },
            { no: 3, name: "match_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TagFileRequest): TagFileRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 file */ 1:
                    message.file = reader.int64().toString();
                    break;
...
class VideoFile$Type extends MessageType<VideoFile> {
    constructor() {
        super("mediacorral.server.v1.VideoFile", [
            { no: 1, name: "id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 2, name: "video_type", kind: "enum", T: () => ["mediacorral.server.v1.VideoType", VideoType, "VIDEO_TYPE_"] },
            { no: 3, name: "match_id", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/ },
            ...
            { no: 9, name: "rip_job", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional int64 rip_job */ 9:
                    message.ripJob = reader.int64().toString();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class MatchInfoItem$Type extends MessageType<MatchInfoItem> {
    constructor() {
        super("mediacorral.server.v1.MatchInfoItem", [
            { no: 1, name: "id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 2, name: "video_file_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 3, name: "ost_download_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
    ...
    create(value?: PartialMessage<MatchInfoItem>): MatchInfoItem {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = "0";
        message.videoFileId = "0";
        message.ostDownloadId = "0";
        message.distance = 0;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 video_file_id */ 2:
                    message.videoFileId = reader.int64().toString();
                    break;
                case /* int64 ost_download_id */ 3:
                    message.ostDownloadId = reader.int64().toString();
                    break;
...
class RipVideoBlobs$Type extends MessageType<RipVideoBlobs> {
    constructor() {
        super("mediacorral.server.v1.RipVideoBlobs", [
            { no: 1, name: "id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 2, name: "job_id", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
