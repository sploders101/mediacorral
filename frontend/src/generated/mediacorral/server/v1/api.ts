...
export interface DriveStatus {
    ...
    driveId: string;
    /**
     * @generated from protobuf field: mediacorral.server.v1.DriveStatusTag status = 2
     */
...
/**
 * @generated from protobuf message mediacorral.server.v1.RipJobStatus
 */
export interface RipJobStatus {
    /**
     ...
     *
     * @generated from protobuf field: uint32 cprog_value = 4
     */
    cprogValue: number;
    /**
     * Total progress
     *
     * @generated from protobuf field: uint32 tprog_value = 5
     */
    tprogValue: number;
    /**
     * The maximum progress value (X "out of" this value)
     *
     * @generated from protobuf field: uint32 max_prog_value = 6
     */
    maxProgValue: number;
    /**
     ...
     *
     * @generated from protobuf field: repeated string logs = 7
     */
    logs: string[];
}
/**
...
/**
 * @generated from protobuf enum mediacorral.server.v1.DriveStatusTag
 */
...
class GetDriveStatusRequest$Type extends MessageType<GetDriveStatusRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDriveStatusRequest): GetDriveStatusRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
/**
 * @generated MessageType for protobuf message mediacorral.server.v1.GetDriveStatusRequest
 */
export const GetDriveStatusRequest = new GetDriveStatusRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetDriveStatusResponse$Type extends MessageType<GetDriveStatusResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDriveStatusResponse): GetDriveStatusResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
/**
 * @generated MessageType for protobuf message mediacorral.server.v1.GetDriveStatusResponse
 */
export const GetDriveStatusResponse = new GetDriveStatusResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DriveStatus$Type extends MessageType<DriveStatus> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* mediacorral.server.v1.RipJobStatus rip_job */ 4:
                    message.ripJob = RipJobStatus.internalBinaryRead(reader, reader.uint32(), options, message.ripJob);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: DriveStatus, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.ripJob)
            RipJobStatus.internalBinaryWrite(message.ripJob, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message mediacorral.server.v1.DriveStatus
 */
export const DriveStatus = new DriveStatus$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RipJobStatus$Type extends MessageType<RipJobStatus> {
    constructor() {
        super("mediacorral.server.v1.RipJobStatus", [
            { no: 1, name: "job_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "cprog_title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "tprog_title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "cprog_value", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "tprog_value", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "max_prog_value", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 7, name: "logs", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<RipJobStatus>): RipJobStatus {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.jobId = 0n;
        message.cprogTitle = "";
        message.tprogTitle = "";
        ...
        message.logs = [];
        if (value !== undefined)
            reflectionMergePartial<RipJobStatus>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RipJobStatus): RipJobStatus {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* string tprog_title */ 3:
                    ...
                    break;
                case /* uint32 cprog_value */ 4:
                    message.cprogValue = reader.uint32();
                    break;
                case /* uint32 tprog_value */ 5:
                    message.tprogValue = reader.uint32();
                    break;
                case /* uint32 max_prog_value */ 6:
                    message.maxProgValue = reader.uint32();
                    break;
                case /* repeated string logs */ 7:
    ...
    internalBinaryWrite(message: RipJobStatus, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 job_id = 1; */
        if (message.jobId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.jobId);
        /* string cprog_title = 2; */
        if (message.cprogTitle !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.cprogTitle);
        /* string tprog_title = 3; */
        if (message.tprogTitle !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.tprogTitle);
        /* uint32 cprog_value = 4; */
        if (message.cprogValue !== 0)
            writer.tag(4, WireType.Varint).uint32(message.cprogValue);
        /* uint32 tprog_value = 5; */
        if (message.tprogValue !== 0)
            writer.tag(5, WireType.Varint).uint32(message.tprogValue);
        /* uint32 max_prog_value = 6; */
        if (message.maxProgValue !== 0)
            writer.tag(6, WireType.Varint).uint32(message.maxProgValue);
        /* repeated string logs = 7; */
        for (let i = 0; i < message.logs.length; i++)
            writer.tag(7, WireType.LengthDelimited).string(message.logs[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message mediacorral.server.v1.RipJobStatus
 */
export const RipJobStatus = new RipJobStatus$Type();
// @generated message type with reflection information, may provide speed optimized methods
