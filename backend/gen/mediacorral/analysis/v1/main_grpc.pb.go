...
const (
	MediaAnalysisService_AnalyzeMkv_FullMethodName = "/mediacorral.analysis.v1.MediaAnalysisService/AnalyzeMkv"
)
...
func (UnimplementedMediaAnalysisServiceServer) AnalyzeMkv(context.Context, *AnalyzeMkvRequest) (*AnalyzeMkvResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AnalyzeMkv not implemented")
}
...
func RegisterMediaAnalysisServiceServer(s grpc.ServiceRegistrar, srv MediaAnalysisServiceServer) {
	// If the following call panics, it indicates UnimplementedMediaAnalysisServiceServer was
...
var MediaAnalysisService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mediacorral.analysis.v1.MediaAnalysisService",
	...
	Metadata: "mediacorral/analysis/v1/main.proto",
}
